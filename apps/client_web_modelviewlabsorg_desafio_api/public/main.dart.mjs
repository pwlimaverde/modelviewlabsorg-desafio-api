...
_1619: (x0,x1) => ({createScript: x0,createScriptURL: x1}),
_1620: (x0,x1,x2) => x0.createPolicy(x1,x2),
_1621: (x0,x1) => x0.createScriptURL(x1),
_1622: (x0,x1,x2) => x0.createScript(x1,x2),
_1623: (x0,x1) => x0.appendChild(x1),
...
_1636: () => new XMLHttpRequest(),
_1637: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
_1638: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
_1639: (x0,x1) => x0.send(x1),
_1641: x0 => x0.getAllResponseHeaders(),
...
_1709: v => v.toString(),
_1710: (d, digits) => d.toFixed(digits),
...
_1852: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
_1853: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
_1859: x0 => x0.trustedTypes,
_1861: (x0,x1) => x0.text = x1,
_1878: (s, m) => {
          try {
...
_1880: (x0,x1) => x0.test(x1),
_1881: (x0,x1) => x0.exec(x1),
_1882: (x0,x1) => x0.exec(x1),
_1883: x0 => x0.pop(),
_1887: (x0,x1,x2) => x0[x1] = x2,
_1889: o => o === undefined,
_1890: o => typeof o === 'boolean',
_1891: o => typeof o === 'number',
_1893: o => typeof o === 'string',
_1896: o => o instanceof Int8Array,
_1897: o => o instanceof Uint8Array,
_1898: o => o instanceof Uint8ClampedArray,
_1899: o => o instanceof Int16Array,
_1900: o => o instanceof Uint16Array,
_1901: o => o instanceof Int32Array,
_1902: o => o instanceof Uint32Array,
_1903: o => o instanceof Float32Array,
_1904: o => o instanceof Float64Array,
_1905: o => o instanceof ArrayBuffer,
_1906: o => o instanceof DataView,
_1907: o => o instanceof Array,
_1908: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
_1910: o => {
            const proto = Object.getPrototypeOf(o);
            return proto === Object.prototype || proto === null;
          },
_1911: o => o instanceof RegExp,
_1912: (l, r) => l === r,
_1913: o => o,
_1914: o => o,
_1915: o => o,
...
_1917: o => o.length,
_1920: (o, i) => o[i],
_1921: f => f.dartFunction,
_1922: l => arrayFromDartList(Int8Array, l),
_1923: (data, length) => {
...
_1924: l => arrayFromDartList(Uint8ClampedArray, l),
_1925: l => arrayFromDartList(Int16Array, l),
_1926: l => arrayFromDartList(Uint16Array, l),
_1927: l => arrayFromDartList(Int32Array, l),
_1928: l => arrayFromDartList(Uint32Array, l),
_1929: l => arrayFromDartList(Float32Array, l),
_1930: l => arrayFromDartList(Float64Array, l),
_1931: (data, length) => {
...
_1932: l => arrayFromDartList(Array, l),
_1933:       (s, length) => {
        if (length == 0) return '';
...
_1942: (o, p) => o[p],
_1943: (o, p, v) => o[p] = v,
_1944: (o, m, a) => o[m].apply(o, a),
_1946: o => String(o),
_1947: (p, s, f) => p.then(s, f),
_1948: s => {
      if (/[[\]{}()*+?.\\^$|]/.test(s)) {
          s = s.replace(/[[\]{}()*+?.\\^$|]/g, '\\$&');
      }
...
_1965: (o, p) => o[p],
_1966: (o, p, v) => o[p] = v,
_1967: (o, p) => delete o[p],
_2078: (x0,x1) => x0.timeout = x1,
_2080: (x0,x1) => x0.withCredentials = x1,
_2083: x0 => x0.status,
_2084: x0 => x0.statusText,
_2086: (x0,x1) => x0.responseType = x1,
_2087: x0 => x0.response,
_3414: (x0,x1) => x0.type = x1,
_3422: (x0,x1) => x0.crossOrigin = x1,
_3424: (x0,x1) => x0.text = x1,
_3899: () => globalThis.window,
_3965: x0 => x0.navigator,
_4227: x0 => x0.trustedTypes,
_4343: x0 => x0.maxTouchPoints,
_4353: x0 => x0.platform,
_6681: () => globalThis.document,
_6776: x0 => x0.head,
