...
class ValidaSenhaController extends GetxController {
  ...
  void onInit() async {
    super.onInit();
    // await FeaturesServicePresenter.to.localStorage.write<String>(key: 'teste', data: 'teste data');
    // teste(await FeaturesServicePresenter.to.localStorage.read<String>('teste'));
